 ...
 */
public class GetChampionDataByIdQuery extends AbstractQuery<com.vgalloy.riot.library.api.query.impl.lolstaticdata.GetChampionDataByIdQuery, ChampionStaticDataDto> {
    ...
    @Override
    public ChampionStaticDataDto execute() {
