 ...
 */
public class GetLeaguesByTeamIdsQuery extends AbstractQuery<com.vgalloy.riot.library.api.query.impl.league.GetLeaguesByTeamIdsQuery, Map<String, List<LeagueDto>>> {
     ...
     * @return this
     */
    public com.vgalloy.riot.library.api.query.impl.league.GetLeaguesByTeamIdsQuery addTeamIds(String... teamIds) {
