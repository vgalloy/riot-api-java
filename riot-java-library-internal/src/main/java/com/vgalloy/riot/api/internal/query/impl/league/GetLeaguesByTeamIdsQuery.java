 ...
 */
public class GetLeaguesByTeamIdsQuery extends AbstractQuery<com.vgalloy.riot.api.api.query.impl.league.GetLeaguesByTeamIdsQuery, Map<String, List<LeagueDto>>> {
     ...
     * @return this
     */
    public com.vgalloy.riot.api.api.query.impl.league.GetLeaguesByTeamIdsQuery addTeamIds(String... teamIds) {
