 ...
 */
public class GetMatchIdListByTournamentCodeQuery extends AbstractQuery<com.vgalloy.riot.api.api.query.impl.match.GetMatchIdListByTournamentCodeQuery, List<Long>> {
