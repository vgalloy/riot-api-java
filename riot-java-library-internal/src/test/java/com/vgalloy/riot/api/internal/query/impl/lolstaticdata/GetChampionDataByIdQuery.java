 ...
 */
public class GetChampionDataByIdQuery extends AbstractQuery<GetChampionDataByIdQuery, ChampionStaticDataDto> {
    ...
    @Override
    protected ChampionStaticDataDto executeWithError() {
